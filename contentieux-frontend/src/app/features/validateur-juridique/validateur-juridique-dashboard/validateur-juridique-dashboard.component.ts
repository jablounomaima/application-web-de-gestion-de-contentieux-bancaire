...
@Component({
  ...
  template: `
    <div class="page-container">
      ...
      <div class="table-card">
        <div class="table-header-bar"><h2>Dossiers en attente de validation juridique</h2></div>
      ...
      <div class="modal-card" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea [(ngModel)]="commentaire" rows="4" [placeholder]="actionType === 'valider' ? 'Observations...' : 'Expliquez le motif du rejet...'"></textarea>
          </div>
          ...
          <div class="modal-footer">
            ...
            <button [class]="actionType === 'valider' ? 'btn-confirm-valider' : 'btn-confirm-rejeter'" (click)="confirmerAction()" [disabled]="soumission">
              {{ soumission ? '⏳...' : (actionType === 'valider' ? '✅ Confirmer validation' : '❌ Confirmer rejet') }}
            </button>
          </div>
        </div>
      </div>
  ...
  styles: [`
    ...
    h1 { margin: 0; font-size: 1.8rem; color: #004d40; }
    ...
    .search-input:focus { border-color: #004d40; box-shadow: 0 0 0 3px rgba(0,77,64,.1); }
    ...
    .data-table thead { background: #004d40; }
    ...
    .num { color: #004d40; font-family: monospace; font-weight: bold; }
    .type-badge { background: #e0f2f1; color: #00695c; padding: 4px 10px; border-radius: 12px; font-size: .8rem; font-weight: 600; }
    ...
    .dossier-ref { margin: 0 0 20px; font-size: 1rem; }
